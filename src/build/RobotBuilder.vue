...
export default {
  ...
  methods: {
    ...
    selectNextBase() {
      ...
      getNextValidIndex(this.selectedBaseIndex, availableParts.torsos.length);
    },
    selectPreviousBase() {
      this.selectedBaseIndex =
      getPreviousValidIndex(this.selectedBaseIndex, availableParts.torsos.length);
    },
  },
};
</script>
